...
#pulls all and resets local changes in subdirectories ./ or $1/ except those which are marked by "touch <dir>/.git/no_updates"
...
TIME=`date +%H:%M:%S`
echo "Pullall (reset local) finished:$TIME"
